...
<section class="hidden md:block hero h-80 bg-center bg-no-repeat" style="
    ...
    <div class="relative">
        <div class="w-full max-w-3xl absolute top-32 px-16 py-2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-igb-li-grey-500 text-center bg-no-repeat" style="background-image: url(https://dummyimage.com/120x120/878787/d1d1d1);background-position: right bottom;">

            <h2 class="heading-2 text-igb-rich-blue-500 font-bold">Lorem ipsum dolor sit amet consectetur adipisicing</h2>
...
<section>
    ...
    <div class="block md:hidden">
        <div class="w-full px-10 py-0 bg-igb-li-grey-500 text-center">
            <h2 class="heading-2 text-igb-rich-blue-500 font-bold">Lorem ipsum dolor sit amet consectetur adipisicing</h2>
...
<section class="py-5">
    ...
    <div class="mx-auto">
        ...
        <div class="">
            ...
            <img class="h-full w-full object-cover md:hidden sm:block" src="https://dummyimage.com/300x100/878787/d1d1d1" alt="placeholder background hero small">
        </div>
    </div>
...
<section class="bg-igb-li-grey-500 p-10 md:pt-36">
    <div class="relative">
        <div class="w-full max-w-4xl absolute -top-24 px-10 py-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">

            <img class="h-auto w-full object-contain hidden md:block" src="https://dummyimage.com/1500x320/878787/d1d1d1" alt="placeholder background hero">
        </div>
    </div>
...
[yd-quote-button text='Black Box quote']
    ...
    <div class="relative">
        <div class="w-full max-w-3xl absolute top-32 px-16 py-2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-igb-li-grey-500 text-center bg-no-repeat"
