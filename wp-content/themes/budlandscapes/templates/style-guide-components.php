...
<div class="bg-igb-li-grey-500 text-center p-8 my-4">
    <h1 class="heading-1 pt-2 text-center">Styleguide - Components</h1>
    <p class="max-w-3xl mx-auto text-igb-dk-grey-500 mb-3">Reusable UI blocks and code snippets to speed up page
        building</p>
...
-->
    ...
    <div class="flex flex-wrap">
        ...
        <div class="md:w-1/2">
            ...
            <p class="my-1">
                <a href="#" class="inline-flex tertiary-link-sm">
                    Secondary link small
                </a>
            </p>
            <p class="my-1">
                <a href="#" class="inline-flex tertiary-link">
                    Secondary link
                </a>
            </p>
            <p class="my-1">
        ...
        <div class="md:w-1/2 bg-igb-grey-500">

            <a href="/contact-us" class="inline-flex tertiary-btn-sm">
                <span>tertiary-btn-sm (icon)</span>
            ...
            <a href="/contact-us" class="inline-flex tertiary-btn">
                <span>tertiary-btn-sm</span>
            </a>
        </div>
    </div>
    ...
    <div class="flex flex-wrap">
        <div class="md:w-1/3">
            <?php echo do_shortcode("[igb-button url='/cheese' text='Primary']"); ?>
        </div>
        <div class="md:w-1/3">
            <?php echo do_shortcode("[igb-button url='/cheese' type='primary' text='Primary + query' qstring='&TEST=123']"); ?>
        </div>
        <div class="md:w-1/3">
            <?php echo do_shortcode("[igb-button size='-sm' url='/cheese' text='Primary Small button']"); ?>
        </div>
    </div>

    <div class="flex flex-wrap">
        <div class="md:w-1/3">
            <?php echo do_shortcode("[igb-button url='/cheese' type='secondary' text='Secondary']"); ?>
        </div>
        <div class="md:w-1/3">
            <?php echo do_shortcode("[igb-button url='/cheese' type='secondary' text='Secondary + query' qstring='&TEST=123']"); ?>
        </div>
        <div class="md:w-1/3">
            <?php echo do_shortcode("[igb-button url='/cheese' type='secondary' size='-sm' text='Secondary Small button']"); ?>
        </div>
    </div>

    <div class="flex flex-wrap">
        <div class="md:w-1/3">
            <?php echo do_shortcode("[igb-button url='/cheese' type='tertiary' text='tertiary']"); ?>
        </div>
        <div class="md:w-1/3">
            <?php echo do_shortcode("[igb-button url='/cheese' type='tertiary' text='tertiary + query' qstring='&TEST=123']"); ?>
        </div>
        <div class="md:w-1/3">
            <?php echo do_shortcode("[igb-button url='/cheese' type='tertiary' size='-sm' text='tertiary Small button']"); ?>
        </div>
    </div>
        ...
        <div class="flex-auto md:flex-1 md:max-w-lg max-w-none">
            <div class="text-center standard-card">
                ...
                <ul class="standard-list">
                    ...
                    <li>Discounts up to <?php echo do_shortcode("[yd_drive_safe_discount_txt]"); ?> if you drive
                        well
                    </li>
                </ul>
            </div>
    ...
    <div class="flex flex-wrap justify-center mb-4">
        ...
        <div class="flex-auto md:flex-1">
            <div class="text-center standard-card">
                ...
                <ul class="standard-list">
                    <li>Drive someone’s car from <?php echo do_shortcode("[learner_quotes_start_from_txt]"); ?> a
                        day*
                    </li>
        ...
        <div class="flex-auto md:flex-1">
            <div class="text-center standard-card">
                ...
                <ul class="standard-list">
                    ...
                    <li>Save an average of <?php echo do_shortcode("[yd_renewal_discount_txt]"); ?> on renewal**
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="flex flex-wrap justify-center mb-4">
        ...
        <div class="flex-auto md:w-1/3">
            <div class="text-center border-0 shadow-none standard-card">
                ...
                <h3 class="heading-3">Earn up to <?php echo do_shortcode("[yd_drive_safe_discount_txt]"); ?> off
                </h3>
                <p>
...
<div class="mx-auto">
    ...
    <div class="py-8 bg-igb-li-grey-500">
...
<div class="container mx-auto">
    ...
    <div class="text-center">
        <div class="bg-igb-li-grey-500 p-4 inline-block">
    ...
    <div class="text-center">
        <div class="bg-igb-rich-blue-500 p-4 inline-block">
    ...
    <div class="text-center">
        <div class="bg-igb-li-grey-500 p-4 w-full">
