    ...
    <div class="flex flex-wrap justify-center mb-4">
        <div class="flex-auto">
            <div id="001" class="standard-card flex">
                <div class="flex-1 p-4">
                    ...
                    <div class="py-3">
                        ...
                        <a download='landing-page-001.jpg' id='landing-page-001'
                            href="/resources/img/style-guide/templates/landing-page-001.jpg"
                            class="inline-flex secondary-btn-clear-sm" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 btn-icon-left" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="flex-1 p-4">
                    <img class="object-cover mx-auto" src="/resources/img/style-guide/templates/landing-page-001.jpg"
            ...
            <div id="002" class="standard-card flex">
                <div class="flex-1 p-4">
                    ...
                    <div class="py-3">
                        ...
                        <a download='landing-page-001.jpg' id='landing-page-001'
                            href="/resources/img/style-guide/templates/landing-page-002.jpg"
                            class="inline-flex secondary-btn-clear-sm" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 btn-icon-left" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="flex-1 p-4">
                    <img class="object-cover mx-auto" src="/resources/img/style-guide/templates/landing-page-002.jpg"
                        alt="placeholder" width="320" height="auto">
                </div>
            ...
            <div id="003" class="standard-card flex">
                <div class="flex-1 p-4">
                    ...
                    <div class="py-3">
                        ...
                        <a download='landing-page-001.jpg' id='landing-page-001'
                            href="/resources/img/style-guide/templates/landing-page-003.jpg"
                            class="inline-flex secondary-btn-clear-sm" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 btn-icon-left" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="flex-1 p-4">
                    <img class="object-cover mx-auto" src="/resources/img/style-guide/templates/landing-page-003.jpg"
                        alt="placeholder" width="320" height="auto">
                </div>
            ...
            <div id="004" class="standard-card flex">
                <div class="flex-1 p-4">
                    ...
                    <div class="py-3">
                        ...
                        <a download='landing-page-004.jpg' id='landing-page-004'
                            href="/resources/img/style-guide/templates/landing-page-004.jpg"
                            class="inline-flex secondary-btn-clear-sm" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 btn-icon-left" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="flex-1 p-4">
                    <img class="object-cover mx-auto" src="/resources/img/style-guide/templates/landing-page-004.jpg"
                        alt="placeholder" width="320" height="auto">
                </div>
