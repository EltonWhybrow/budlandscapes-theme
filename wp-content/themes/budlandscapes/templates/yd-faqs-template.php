...
<div class="py-0">
    <img class="h-full w-full object-cover hidden md:block" src="/resources/img/pages/hero-banners/yd-faqs.svg" alt="young driver frequently asked questions">
    <img class="h-full w-full object-cover md:hidden sm:block" src="/resources/img/pages/hero-banners/yd-faqs.svg" alt="young driver frequently asked questions">
</div>
