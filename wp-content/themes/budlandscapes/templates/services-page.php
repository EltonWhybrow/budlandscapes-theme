    ...
    <section class="w-full bg-gray-700">
        <div class="flex max-w-5xl mx-auto pt-5 md:pt-10 pb-12 space-x-5">
            ...
            <div class="px-5 text-base">
                ...
                <p class="py-2">Here at Bud Design &amp; Landscaping we pride orselves on pushing th eboudaries with what possible when it comes to outdoor spaces. We cover all aspects of garden creations from custom made offices &amp; cabins to the beautifull planting and lanscaped retreats. Learn some more about what we offer below or contact us to <a class="relative text-base text-white hover:underline" href="/contact">arrange a visit</a> today.</p>
            </div>
        </div>
    </section>
    ...
    <section class="max-w-5xl mx-auto py-10 md:py-24">
        ...
        <div class="mx-2 flex flex-wrap md:flex-nowrap">
            ...
            <div class="w-full md:w-3/5 px-5">
                ...
                <h4 class="pt-2 font-semibold">Let us keep you garden in tip-top shape</h4>
                <p class="text-base text-gray-700">Our team are highly experienced in ground keeping large garden area, maintaining gardens space is half the challenge. We can provide one off, occasional or regular visits and can set up a contract if you wish. Both domestic and commercial customers can benefit from our expert gardening knowledge and experience. We also develop low maintenance gardens for those with busy lifestyles or mobility challenges.</p>
                <div class="py-2">
                    <a class="relative inline-flex primary-btn pr-6" href="/contact">
                        Enquire
                        <svg xmlns="http://www.w3.org/2000/svg" class="absolute top-3 right-1 inline-block w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
