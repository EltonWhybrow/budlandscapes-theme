        ...
        <div class="flex flex-col sm:flex-row flex-wrap items-center sm:items-start justify-between p-2 text-white space-y-6 md:space-y-0">
            ...
            <div class="w-full sm:2/6 md:w-3/6 p-0 sm:p-1 text-center">
                <picture>
                    ...
                    <img class="mx-auto" src="/resources/img/pages/logos/partners/hc-one-logo.jpg" alt="HC one - The kind care company">
                </picture>
            </div>
            ...
            <div class="w-full sm:2/6 md:w-3/6 p-0 text-xs sm:p-1 text-center">
                <picture>
                    ...
                    <img class="mx-auto" src="/resources/img/pages/logos/partners/adamson-logo.jpg" alt="Adamson construction">
                </picture>
            </div>
            ...
            <div class="w-full sm:2/6 md:w-3/6 p-0 text-xs sm:p-1 text-center">
                <picture>
                    ...
                    <img class="mx-auto" src="/resources/img/pages/logos/partners/ruggles-and-jeffery-logo.jpg" alt="Ruggles and Jeffery">
                </picture>
            </div>
            ...
            <div class="w-full sm:2/6 md:w-3/6 p-0 text-xs sm:p-1 text-center">
                <picture>
                    ...
                    <img class="mx-auto" src="/resources/img/pages/logos/partners/wcr-org-logo.jpg" alt="WCR Org">
                </picture>
            </div>
