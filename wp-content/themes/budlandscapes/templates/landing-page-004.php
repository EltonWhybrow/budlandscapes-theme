...
<section class="container max-w-5xl mx-auto p-6 pb-16 text-center">
    ...
    <div class="flex flex-wrap justify-center mb-4">
        <div class="flex-auto md:w-1/4">
            <div class="text-center border-0 shadow-none standard-card">
                <img class="object-cover mx-auto" src="https://dummyimage.com/96x96/878787/d1d1d1" alt="upfront savings" width="96" height="96">
    ...
    <div class="flex flex-wrap justify-center mb-4">
        <div class="flex-auto md:flex-1 inline-flex justify-center text-sm">
            <svg xmlns="http://www.w3.org/2000/svg" class="btn-icon-left" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="flex flex-wrap justify-center mb-4">
            <div class="flex-auto md:flex-1">
                <div class="text-center standard-card border-0 shadow-none">
                    ...
                    <ul class="standard-list list-none text-center">
                        <li class="mb-1">
                            <p class="inline">
                                <svg xmlns="http://www.w3.org/2000/svg" class="inline h-12 w-12 pr-1 pb-1 text-success-900" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="flex-auto md:flex-1">
                <div class="text-center standard-card border-0 shadow-none">
                    ...
                    <img class="object-cover mx-auto w-4/5" src="https://dummyimage.com/600x480/878787/d1d1d1" alt="driving tips" width="600" height="auto">
