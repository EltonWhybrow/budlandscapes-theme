                ...
                <div class="flex-auto sm:w-1/2 lg:w-1/3">
                    <div class="standard-card p-0 relative">
                        ...
                        <?php if (has_post_thumbnail()) : ?>
                            <a href="<?php the_permalink() ?>"><img class="object-cover object-center w-full h-32 md:w-full md:h-32" src="<?php the_post_thumbnail_url('blog-large'); ?>" alt="<?php the_title(); ?>">
                            <?php endif; ?></a>
                            ...
                            <div class="p-4 pt-1">
                                ...
                                <p class="p-2 sm:px-0 text-xs">
                                    <span class="mt-2 text-xs font-thin uppercase text-igb-orange-500"><?php the_date('F j, Y'); ?></span>
                                </p>
