...
<header class="top-0 z-50 justify-between bg-gray-900 bg-opacity-80 absolute" style="width:100%;">
    ...
    <div class="xl:container xl:mx-auto flex justify-between md:justify-evenly">
        ...
        <div class="flex-none pt-5 pb-2 pr-3 text-right text-sm md:text-base">
            <p>
                <a class='relative primary-btn text-xl pr-10' href='tel:<?php echo do_shortcode("[bl_mobile_number]"); ?>'>
